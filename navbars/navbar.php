	...
	<div class="navbar-fixed">
		<nav>
			<div class="nav-wrapper light-blue accent-3 z-depth-2">
				<a href="#" class="brand-logo">OCTPs&reg;</a>
				<ul id="nav-mobile" class="right hide-on-med-and-down">
					<li><a href="index.php"><i class="material-icons left">person_pin</i>Login</a></li>
					<li><a href="#"><i class="material-icons left">info</i>Help</a></li>
					<li><a href="#"><i class="material-icons left">comment</i>Feedback</a></li>
				</ul>
			</div>
		</nav>
	</div>
