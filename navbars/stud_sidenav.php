<div class="navigation" style="border-right: 1px solid #e8e8e8;margin-left: -15px;">
	<ul class="nav-demo">
		<li id="h_menu_item" class="active"   style="margin-right: -6px;"><a href="#home"><i class="material-icons left icon blue-text">home</i><span class="menu_name">Home</span></a></li>
		<li id="a_menu_item"  style="margin-right: -6px;"><a href="#apply"><i class="material-icons left icon orange-text">insert_drive_file</i><span class="menu_name">Apply Now</span></a></li>
		<li id="d_menu_item"  style="margin-right: -6px;"><a href="#download_assessment"><i class="material-icons left icon green-text">file_download</i><span class="menu_name">Assessment Form</span></a></li>

		<div class="divider"></div>
		<li class="grey-text text-accent-1 header disabled">Supervision</li>
		<li  style="margin-right: -6px;"><a href="#"><i class="material-icons left icon">supervisor_account</i><span class="menu_name">Super. Details</span></a></li>
